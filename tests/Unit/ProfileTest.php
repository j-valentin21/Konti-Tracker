...
class ProfileTest extends TestCase
{
    ...
    public function test_Reset_Months():void
    {
        ...
        $verify = array('Jan' => 6, 'Feb' => 4, 'Mar' => 0, 'Apr' => 0, 'May' => 0, 'June' => 0,
            'July' => 6, 'Aug' => 4, 'Sept' => 4, 'Oct' => 10, 'Nov' => 4, 'Dec' => 8);

        $expected = array('Jan' => 0, 'Feb' => 0, 'Mar' => 0, 'Apr' => 0, 'May' => 0, 'June' => 0,
            'July' => 0, 'Aug' => 0, 'Sept' => 0, 'Oct' => 0, 'Nov' => 0, 'Dec' => 0);

        $profile->resetMonths();

        $result = $profile->pto_usage;
        $result2 = $profile->points_usage;

        $this->assertNotEquals($verify, $profile->pto_usage);
        $this->assertNotEquals($verify, $profile->points_usage);
